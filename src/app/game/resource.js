...
export default class Resource extends MatterEntity{
    ...
    scene.load.atlas('resources', 'assets/objects/resources.png', 'assets/objects/resources_atlas.json');
    ...
    constructor(data){
      ...
      super({scene,x:resource.x, y:resource.y, texture: 'resources', frame: resource.type, drops:drops,depth: depth, health:5,name:resource.type});
